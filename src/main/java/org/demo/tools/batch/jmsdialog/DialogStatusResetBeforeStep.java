...
public class DialogStatusResetBeforeStep implements StepExecutionListener {

	private static final BasicLogger LOGGER = BasicLogger.getLogger( DialogStatusResetBeforeStep.class );
